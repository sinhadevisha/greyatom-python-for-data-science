...
print("First Line of Message: ", sample_message)
...
#Calling the function to read file 1 
message_1 = read_file(file_path_1)

#Calling the function to read file 2
...
def compare_msg(message_d, message_e):
    ...
    #Splitting the message_d into a list
    a_list = message_d.split(" ")
    
    #Splitting the message_e into a list
...
print("Complete Secret Message: ", secret_msg)
